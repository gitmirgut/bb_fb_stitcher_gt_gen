...
# gt.__load_csv('/mnt/myStorage/bb_fb_stitcher_gt_gen/tests/data/test_csv_output/Output/data.csv')
# gt.save_2_json('/mnt/myStorage/bb_fb_stitcher_gt_gen/tests/data/test_csv_output/Output/data.json')
# data = core.GroundTruthGenerator.load_json('/mnt/myStorage/bb_fb_stitcher_gt_gen/tests/data/test_csv_output/Output/data.json')
